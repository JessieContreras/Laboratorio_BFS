...
if __name__ == "__main__":
    ...
    grafo.add_grafo(dato2, dato4)
    grafo.add_grafo(dato2, dato5)
    grafo.add_grafo(dato1, dato3)
    grafo.add_grafo(dato6, dato3)
    grafo.add_grafo(dato3, dato7)
    grafo.add_grafo(dato8, dato3)
    grafo.add_grafo(dato5, dato6)
    ...
    print(f" El camino transversal del nodo 1 al 8 nodo es {dato1, dato2, dato6, dato4, dato6, dato5, dato7, dato8}")
